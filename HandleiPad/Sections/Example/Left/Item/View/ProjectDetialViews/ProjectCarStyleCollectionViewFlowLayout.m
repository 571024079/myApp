//
//  ProjectCarStyleCollectionViewFlowLayout.m
//  HandleiPad
//
...
@interface ProjectCarStyleCollectionViewFlowLayout ()
...
@implementation ProjectCarStyleCollectionViewFlowLayout
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.sectionInset = UIEdgeInsetsMake(5.0f, 10.0f, 5.0f, 10.0f);
    }
    return self;
}
