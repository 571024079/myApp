...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    [_imageview sd_setImageWithURL:url placeholderImage:_imageview.image options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
        ...
        [_waitingView removeFromSuperview];
                ...
                if (image.size.width > _imageview.bounds.size.width || image.size.height > _imageview.bounds.size.height)
                {
