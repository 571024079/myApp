...
//        CGFloat Ratio = height/568.0;
        ...
        {
            leftBottom = CGPointMake(250, 768 - 300);
            rightBottom = CGPointMake(1024 - 250, 768 - 300);
            leftTop = CGPointMake(250, 300);
            rightTop = CGPointMake(1024 - 250, 300);
            self.centerRect = CGRectMake(250, 300, 1024 - 500, 768 - 300 * 2);
        }
        else
        { //iphone 5/5s/6/6 plus/6s/6s plus
